...
// draggedElement: any;
  ...
  // createBoardSubtasks(taskcompleted, taskall, percent) {
  //     return `
  //     <div class="board_task_progess_empty">
  //         <div id="progress-bar-25" class="board_task_progess" role="progressbar" aria-valuenow="75"
  ...
  // createBoradCard(id, story, story_bg, headline, text, date, priority, priority_img) {
  //     return `
  ...
  // createBoardCardUsers(first_name, user, color) {
  //     return `
  //     <div class="board_dfcb" style="margin-top: 20px;margin-left: 25px;">
  ...
  // createBoardCardSubtaks(id, i, status, text, img) {
  //     return `
